...
We set a penalised complexity prior: $P(\sigma_r > 0.05) = 0.01$.
...
We set a penalised complexity prior: $P(\rho > 0.6) = 0.7$.
...
We set a penalised complexity prior: $P(\sigma_s > 0.1) = 0.05$.
...
We set a penalised complexity prior: $P(r < 50) = 0.5$.
