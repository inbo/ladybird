...
```{r {{id}}-map, eval = any(this_predictions$year <= 1997)}
this_predictions %>%
  filter(year <= 1997) %>%
...
```{r {{id}}-map-presence, eval = any(this_predictions$year <= 1997)}
this_predictions %>%
  filter(year <= 1997) %>%
...
```{r {{id}}-map-presence2, eval = any(this_predictions$year <= 1997)}
this_predictions %>%
  filter(year <= 1997) %>%
